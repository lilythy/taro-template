...
import { ExtraInfo, CalendarMark, CurrentState } from "./type";
...
class CustomCalendar extends Component<CurrentProps, CurrentState> {
  public static defaultProps: Partial<CurrentProps> = {
    isVertical: false,
    marks: [],
  ...
  componentWillReceiveProps(nextProps: Readonly<CurrentProps>): void {
    if (
